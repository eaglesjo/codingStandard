...
function AddFiles([System.Collections.Generic.List[string]]$list,[string]$domain){
  if($domain -eq 'common'){
    $list.AddRange([string[]]@('AGENTS.md','CLAUDE.md','GEMINI.md','.github/copilot-instructions.md','.cursor/rules/coding-standard.mdc','.windsurf/rules/coding-standard.md','.clinerules/01-coding-standard.md','.continue/rules/01-coding-standard.md','.junie/AGENTS.md','.amazonq/rules/coding-standard.md','.aider.conf.yml','core/common/AGENT.md','core/common/SKILL.md','core/common/ENVIRONMENT.md','core/common/environment.py','core/common/experiment.py','domains/manus/PROJECT_INSTRUCTIONS.md','domains/manus/SKILL.md','domains/manus/README.md'))
